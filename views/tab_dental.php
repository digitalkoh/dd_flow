	...
	<div class="container clearfix">
        <div class="col-a col-w100">
            <div class="block bb1">
                ...
                <div class="col-nested col-w75"><h2>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</h2></div>
                <div class="clear"></div>
            </div><!-- /.block -->
            ...
            <div class="block bb1">
             ...
             <div class="block mb10" id="remember">
                ...
                <div class="col-nested col-w75"><?php echo _result_dental_remember ?></div>
                <div class="clear"></div>
            </div><!-- /.block #remember -->
