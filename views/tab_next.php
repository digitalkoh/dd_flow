   ...
   <?php include 'inc/inc_nav.php'; ?>
	...
	<div class="container clearfix">
        <div class="col-a col-w100">
            <div class="block bb1">
                <div class="col-nested col-w25"><h3 class="label">Text.</h3><h2>Steps</h2></div>
                <div class="col-nested col-w75">
                    
                    <div class="col-nested col-w100" id="nextOptions">
                        <a href="#next-email" class="icon rnd mail-lg fancybox-form">Text text.</a>
                        <a class="icon rnd check-lg">Text <strong>Text</strong>.</a>
                        <a href="#next-survey" class="icon rnd talk-lg fancybox-form">Text text.</a>
                    </div>
                </div>
                <div class="clear"></div>
            </div><!-- /.block -->
